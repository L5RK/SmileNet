...
class SmileNet(torch.nn.Module):
    ...
    def train(self, data, strikes, epochs=1000, optimizer=None):
        ...
        for e in range(epochs):
            ...
            transformed = [p_to_f(p, self.low) for p in polys]
            ...
            if True: #e%10==0:
                ...
                # eplot_polys(gpolys, torch.hstack([torch.tensor(self.strike_low) , boundaries, torch.tensor(self.strike_high)]), e, 'git','g')
